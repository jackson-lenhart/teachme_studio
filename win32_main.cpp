			...
			while (!should_quit) {
          	...
          	0
						...
						for (int sample_index = 0; sample_index < region1_sample_count; sample_index++) {
							short sample_value = (running_sample_index++ / (square_wave_period / 2)) % 2 ? tone_volume : -tone_volume;
